...
func main() {
	...
	api := r.Group("")
	{
		protected := api.Use(middlewares.Authorizes())
		{
			...
			protected.GET("/employee/:id", controller_payment.GetEmployee)
			protected.GET("/employees", controller_payment.ListEmployee)
			protected.POST("/employees", controller_payment.CreateEmployee)

			// registation Routes
			protected.GET("/bookings", controller_payment.ListBooking)
			protected.GET("/booking/:id", controller_payment.GetBooking)
			protected.GET("/booking/user/:id", controller_payment.GetBookingByUser)


			protected.GET("/food_ordereds", controller_payment.GetFoodOrdered)
	...
	r.POST("/login", controller_payment.Login)
